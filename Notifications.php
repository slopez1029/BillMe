 ...
 */
$query = "SELECT * FROM Notifications WHERE PayerID = '$payerID' AND TYPE = 'Payment Confirm Request'";
...
{        
	while ($row = $result->fetch_assoc()) 
	{
		...
		<td align = 'center'><input type='checkbox' name = 'checklist[]' value = '{$row['PayString']}' /></td>             
		</tr>\n"; 
		//}
