...
{    	  
	...
	*/
	$query = "DELETE FROM Bills WHERE PayerID = '$removedPayer' AND GroupAdmin = '$groupAdmin' ";
	if ($result = $mysqli->query($query)) {}  
		
	$query = "DELETE FROM UserBills WHERE PayerID = '$removedPayer' AND GroupAdmin = '$groupAdmin' ";
	if ($result = $mysqli->query($query)) {} 
...
$type = "PayerRemoved";
$payString = "";
$content = "$removedPayer has left the $groupName group! Personal bills have been updated.";
$payerID = "public";
