...
if(!$alreadyExists)
{
    ...
    */
    ...
    $content2 = "The split cost for the $name bill you added is $$splitCost.";
	...
	{
	    $query = "INSERT INTO Notifications (Type,Content,PayerID,GroupName,GroupAdmin,PayString) VALUES ('$type','$content2','$id','$groupName','$groupAdmin','$payString')";
            if ($result = $mysqli->query($query)){}	    
	}
    }
